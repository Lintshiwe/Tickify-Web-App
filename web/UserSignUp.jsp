    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing:border-box; }
            ...
            @media(max-width:560px){ .role-selection{grid-template-columns:1fr;} .footer-top{grid-template-columns:1fr;} }
        </style>
        <script>
    ...
    <body onload="toggleFields()" data-interest="Account Registration">
        ...
        <main>
            <div class="form-container">
                ...
                <% } %>
                <form action="${pageContext.request.contextPath}/RegistrationServlet.do" method="POST">
